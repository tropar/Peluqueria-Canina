...
public class CargaDatos extends javax.swing.JFrame {
    ...
    public CargaDatos() {
        //Otra forma de setear la instancia hacia la CONTROLADORA de LOGICA.
        //DECLARANDO la variable de arriba, sin INICIALIZARLA.
//        control = new Controladora();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Adrian Capcha\\Desktop\\coker-2634079_640.jpg")); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbAlergico, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel7)
                        .addGap(18, 18, 18)
                        .addComponent(cmbAtEsp, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        //Sirve para SETEAR el VALOR en BLANCO de los campos de txt
        txtNombre.setText("");        
        txtRaza.setText("");
        txtColor.setText("");
        ...
        //Sirve para que vuelva a la primera posición del índice(0 o -)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //El método .getText sirve para guardar el valor de los campos de txt.
        String nombreMasco = txtNombre.getText();
        String raza = txtRaza.getText();
        String color = txtColor.getText();
        String observaciones = txtObservaciones.getText();
        
        //Para CONVERTIR a STRING el valor de los campos de CMB, hace falta hacer un CASTEO.
        ...
        //CREAR método para enviar hacia la CONTROLADORA de la capa de LOGICA
        control.guardar(nombreMasco, raza, color, observaciones, alergico, atenEsp, nombreDuenio, celDuenio);
        
        //CREAR una ventana emergente luego de realizar la acción de GUARDAR
        JOptionPane optionPane = new JOptionPane("Se guardo correctamente");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog = optionPane.createDialog("Guardado Exitoso");
        
        //Para SUPERPONER la ventana emergente
        dialog.setAlwaysOnTop(true);
        
        //Para que la VENTANA EMERGENTE se CENTRE
